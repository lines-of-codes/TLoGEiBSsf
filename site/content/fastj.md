...
description = "A free and open-source 2D game engine and framework, aiming to provide the best 2D game-making experience in Java (and other JVM languages)."
date = "2023-08-21"
updated = "2026-07-08"

[extra]
title_color = "linear-gradient(to right, color-mix(#1b6cf9, var(--text-color) 25%), var(--text-color), color-mix(#ee8300, var(--text-color) 25%))"
+++
...
Or if you prefer to setup all the tools and your project on your PC, you can follow [this official guide](https://fastjengine.github.io/wiki/fastj-basics/fastj-quick-start) to quickly get started on setting up your project in a standard way.
